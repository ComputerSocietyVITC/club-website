...
export const items = [
  {
    ...
    content: (
      <div className="about-us-content">
        ...
        stubborn persistence to keep going, with a healthy ambition for the next
        audacious challenge. Come join us on this journey!
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="our-vision-content">
        At IEEE Computer Society VITC, our belief is grounded in the principles
        of mutual learning and growth. We believe in empowering the community to
        innovate, develop, create, and to empower itself, which for us is, the
        greatest Return on Investment for a Technical Society. With a
        transcendent passion for Tech, and a solemn cognizance of people's
        struggles, we aspire to solve the great problems of today, and prepare
  ...
  },
  {
    ...
    content: (
      <div className="newsletter-content text-center">
        Want to stay updated with the latest news about IEEE CS VITC? Enter your
