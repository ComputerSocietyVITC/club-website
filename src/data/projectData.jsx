...
const slides = [
  {
    ...
    description: (
      <div>
        <div>
          Created for the IEEE ComSoc Arcade Expo Event 2024 at VIT Chennai,
          India, Hydro-Rush is an action-packed shooter game developed by Shlok.
          This exciting project was also showcased at our club's tech carnival
          event.
        </div>
        <div>
          In Hydro-Rush, players control a character navigating through
          challenging levels, dodging obstacles, and managing their health,
          ammo, and score. The game features indicators for health, ammo, and
          score to enhance the gaming experience.
        </div>
        <div>
          Hydro-Rush exemplifies our commitment to fostering creativity and
          technical skills among our members. We are proud to present this
          project as part of our club's achievements.
        </div>
      </div>
    ),
    img: hydro,
  ...
  },
  {
    ...
    description: (
      <>
        The starting point for your tech journey. Get started and explore your
        favorite domain in tech. Whether you're just starting out or you're an
        experienced developer looking to take your skills to the next level, our
        documentation has something for everyone. Visit at{" "}
        <a
          href="https://docs.ieeecsvitc.com"
